...
def expense_recorder():
    ...
    # Adding the 'Card Used' selection
    card_options = ['Apple', 'Discover', 'Chase', 'Amazon', 'Best Buy', 'Cash']
    card_used = st.selectbox("Card Used:", card_options)
    ...
    if st.button("Record Expense"):
        with open('expenses.csv', 'a', newline='') as file:
            ...
            writer.writerow([date, store, category, amount, notes, card_used])
